...
import KhizRepairs from "../Assets&Images/KihzRepairs.gif";
...
export const Projects = {
  ...
  ReactJs: [
    {
      Name: "Bussiness Website Landing Page",
      Disc: "A single page webite for a Electroncs Repair Shop with working contact form for customers.",
      Image: KhizRepairs,
      Link: "https://github.com/Sanidhya22/Khizrepairs",
    },
    {
